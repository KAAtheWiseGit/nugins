...
export extern uv [
	...
	--python-fetch: string@python-fetch # Deprecated version of [`Self::python_downloads`]
	--quiet(-q)               # Do not print any output
	--verbose(-v)             # Use verbose output
	--no-color                # Disable colors
	--color: string@color # Control the use of color in output
...
export extern "uv run" [
	...
	--index-strategy: string@index-strategy # The strategy to use when resolving against multiple index URLs
	--keyring-provider: string@keyring-provider # Attempt to use `keyring` for authentication for index URLs
	--resolution: string@resolution # The strategy to use when selecting between the different compatible versions for a given package requirement
	--prerelease: string@prerelease # The strategy to use when considering pre-release versions
	--pre
	--fork-strategy: string@fork-strategy # The strategy to use when selecting multiple versions of a given package across Python versions and platforms
	...
	--link-mode: string@link-mode # The method to use when installing packages from the global cache
...
export extern "uv init" [
	...
	--build-backend: string@build-backend # Initialize a build-backend of choice for the project
...
export extern "uv export" [
	--format: string@format # The format to which `uv.lock` should be exported
...
export extern "uv tool list" [
	...
	--python-preference: string@python-preference
	--no-python-downloads
	--no-cache(-n)            # Avoid reading from or writing to the cache, instead using a temporary directory for the duration of the operation
	--cache-dir: path         # Path to the cache directory
	--allow-python-downloads  # Allow automatically downloading Python when required. [env: "UV_PYTHON_DOWNLOADS=auto"]
